#!/bin/bash
datarcp45="./Hist_plus_RCP45"
datarcp85="./Hist_plus_RCP85"
...
# Select the data from year 2003 - 2008 and calculate the mean variability factor v
# RCP45
cd ${precrcp45}
tlist1=( $(ls -1 PR_2003_?.nc | cut -c 9-9) )
tlist2=( $(ls -1 PR_2003_??.nc | cut -c 9-10) )
tlist=("${tlist1[@]}" "${tlist2[@]}")
nt=${#tlist[@]}
# for((p=0; p<$nt; p++)) do
#    flist=`ls PR_200[678]_${tlist[p]}.nc`
...
cd ${fw}
# for((p=0; p<$nt; p++)) do
#    flist=`ls fw_frac_200[678]_${tlist[p]}.nc`
